...
const TypewriterEffect = () => {
  const sequences = ["Surendar", "Frontend Developer"]; // Words to display
...
const HeroSection = () => {
  const handleDownload = () => {
    ...
    link.href = "/My Update Resume.pdf"; // URL or path to the file
    link.download = "CV.pdf"; // Specify the filename for the download
    link.click(); // Trigger the download
  };

  return (
    <div id="home" className="relative bg-custom-gradient scroll-smooth">
      ...
      {/* Content Section */}
      <section className="relative top-32 lg:left-48 lg:top-32 z-10">
        <div className="grid grid-cols-1 sm:grid-cols-12 items-center">
          <div data-aos="fade-right" className="col-span-1 sm:col-span-7">
            ...
            <div className="flex flex-col gap-2 sm:flex-row items-center sm:ml-10">
              <Link
                href="#contact"
                className="px-6 py-2 w-full border-1 border-white-transparent sm:w-auto rounded-full mr-0 sm:mr-4 bg-[#FFF] text-black text-lg font-medium hover:bg-fuchsia-700/50 text-center"
              >
                Hire Me
              </Link>
              <button
